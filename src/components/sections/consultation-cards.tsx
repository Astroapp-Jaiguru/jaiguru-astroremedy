        ...
        <RevealGroup className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {CONSULTATION_TOPICS.map((card) => {
            ...
            return (
              ...
              <div
                className="group relative flex flex-col overflow-hidden rounded-3xl glass-card p-6 transition duration-300 hover:-translate-y-1 hover:border-[#D4AF37]/80 hover:shadow-[0_16px_50px_rgba(212,175,55,0.28)]"
              >
                ...
                <div className="flex flex-wrap items-center justify-between gap-3">
                  ...
                  <a
                    ...
                    className="btn-glow-whatsapp inline-flex items-center gap-2 whitespace-nowrap rounded-full bg-[#25D366] px-4 py-2 text-xs font-semibold text-white shadow-[0_8px_25px_rgba(37,211,102,0.4)] transition hover:bg-[#1EBE5B]"
                  >
