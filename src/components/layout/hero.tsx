...
export async function Hero() {
  ...
  return (
    <section className="relative overflow-hidden bg-hero-gradient text-white">
      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-14 px-4 pb-20 pt-4 sm:px-6 lg:min-h-[720px] lg:grid-cols-[55fr_45fr] lg:gap-10 lg:px-8 lg:pb-24 lg:pt-4">
        {/* Left: content */}
