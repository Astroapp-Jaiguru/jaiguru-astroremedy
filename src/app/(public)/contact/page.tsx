              ...
              return card.href ? (
                <a
                  ...
                  {...(card.external
                    ...
                    : {})}
                  className="flex items-center gap-3 rounded-2xl border border-[#D4AF37]/30 bg-gradient-to-b from-[#1E1B4B]/80 to-[#0F172A]/80 p-5 shadow-[0_8px_30px_rgba(0,0,0,0.35)] backdrop-blur transition-colors hover:border-[#FACC15]/60"
                >
                  {inner}
                </a>
              ) : (
                <div
                  key={card.label}
                  className="flex items-center gap-3 rounded-2xl border border-[#D4AF37]/30 bg-gradient-to-b from-[#1E1B4B]/80 to-[#0F172A]/80 p-5 shadow-[0_8px_30px_rgba(0,0,0,0.35)] backdrop-blur"
                >
                  {inner}
                </div>
              );
